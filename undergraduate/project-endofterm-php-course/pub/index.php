...
<head>
    ...
    <title>Online Study - Education Category Responsive Web Template - Home</title>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 banner-left pt-md-0 pt-5">
                    ...
                    <div class="mt-md-5 mt-4 mb-lg-0 mb-4">
                        <a class="btn button-style" href="about.php">Get Started<i class="fa fa-angle-double-right"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 features15-col-text">
                        <a href="courses.php" class="d-flex feature-unit align-items-center">
                            <div class="col-4">
                    ...
                    <div class="col-lg-4 col-md-6 features15-col-text">
                        <a href="courses.php" class="d-flex feature-unit align-items-center active">
                            <div class="col-4">
                                <div class="features15-info">
        ...
        <div class="container pb-2">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 about-right-faq align-self mb-lg-0 mb-5 pl-xl-5">
                    ...
                    <a class="btn button-style button-2 mt-lg-5 mt-4" href="about.php">Read More<i
