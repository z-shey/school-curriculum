...
<head>
    ...
    <title>Online Study - Education Category Responsive Web Template - Contact</title>
    <!-- google-fonts -->
...
<body>
                                ...
                                <div class="popup">
                                    ...
                                    <form action="#error" method="GET" class="search-box">
                                        <div class="input-search"> <span class="fa fa-search mr-2"
                                                ...
                                                placeholder="Enter Keyword" name="search" required
                                                autofocus="">
                                        </div>
    ...
    <footer class="w3l-footer-22 position-relative mt-5 pt-5">
            ...
            <div class="container">
                <div class="text-txt">
                    <div class="right-side text-center">
                        ...
                        <a class="btn button-style mt-4" href="about.php">Get Started<i
        ...
        <div class="copyright-footer text-center">
            <div class="container">
                <div class="columns">
                    <p>@2020 Online Study. All rights reserved. <a target="_blank" href="http://www.mobanwang.com/" title="网页模板">网页模板</a>
                    </p>
                </div>
            </div>
        </div>
